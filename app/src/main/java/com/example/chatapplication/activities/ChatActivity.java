...
public class ChatActivity extends BaseActivity {
    ...
    private void init(){
        ...
        chatAdapter = new ChatAdapter(
                chatMessages,
                getBitmapEncodedString(receiveUser.image),
    ...
    private void sendMessage(){
        Log.d("ChatActivity", "sendMessage: Message sent");
        ...
        if (conversionId != null){
            ...
            conversion.put(Constants.KEY_RECEIVERNAME, receiveUser.name);
            conversion.put(Constants.KEY_RECEIVER_IMAGE,receiveUser.image);
            conversion.put(Constants.KEY_LAT_MESSAGE, binding.inputMessage.getText().toString());
    ...
    private void listenMessages(){
        Log.d("ListenMessages", "Listening for messages...");
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if(value !=null){
            Log.d("EventListener", "Received new snapshot with " + value.size() + " documents");
            int count = chatMessages.size();
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType() == DocumentChange.Type.ADDED)
                {
                    Log.d("EventListener", "New message received: " + documentChange.getDocument().getId());
    ...
    private void updateConversion(String message){
        ...
        documentReference.update(
                Constants.KEY_LAT_MESSAGE,message,
