...
public class RecentConversatioAdaptor extends RecyclerView.Adapter<RecentConversatioAdaptor.ConversionViewHolder>
{
    private final List<ChatMessage> chatMessages;
    private final ConversionListener conversionListener;

    public RecentConversatioAdaptor(List<ChatMessage> chatMessages, ConversionListener conversionListener) {
